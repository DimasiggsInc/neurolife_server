...
## Проект для хакатона Кибер Рывок.
### Тема: «Виртуальный мир – симулятор живых существ с памятью, эмоциями и веб-интерфейсом».
### Цель: Создать веб-приложение, в котором несколько автономных AI-агентов живут своей жизнью:
